...
const WEDDING_CONFIG: WeddingConfig = {
  bride: 'Яна',
  groom: 'Иван',
  date: new Date('2026-06-10T16:00:00'),
  venue: {
  ...
  schedule: [
    { time: '16:00', title: 'Церемония бракосочетания', icon: '💍' },
    { time: '17:00', title: 'Фуршет и фотосессия', icon: '🥂' },
    { time: '18:30', title: 'Торжественный банкет', icon: '🍽️' },
    { time: '20:00', title: 'Первый танец', icon: '💃' },
    { time: '20:30', title: 'Торт и поздравления', icon: '🎂' },
